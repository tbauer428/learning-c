...
{
   struct coordinate_t landing_position = { -9.0F, 9.0F };
   uint8_t expected = 0;
...
static void test_on_the_outer_circle(void)
{
   ...
   struct coordinate_t landing_position = { 0.0F, 10.0F };
   uint8_t expected = 1;
   uint8_t actual = score(landing_position);
   TEST_ASSERT_EQUAL_UINT8(expected, actual);
}
...
{
   TEST_IGNORE();
   struct coordinate_t landing_position = { -5.0F, 0.0F };
   uint8_t expected = 5;
   uint8_t actual = score(landing_position);
   TEST_ASSERT_EQUAL_UINT8(expected, actual);
}
...
{
   TEST_IGNORE();
   struct coordinate_t landing_position = { 0.0F, -1.0F };
   uint8_t expected = 10;
   uint8_t actual = score(landing_position);
   TEST_ASSERT_EQUAL_UINT8(expected, actual);
}
...
{
   TEST_IGNORE();
   struct coordinate_t landing_position = { 0.0F, 0.0F };
   uint8_t expected = 10;
   uint8_t actual = score(landing_position);
   TEST_ASSERT_EQUAL_UINT8(expected, actual);
}
...
{
   TEST_IGNORE();
   struct coordinate_t landing_position = { -0.1F, -0.1F };
   uint8_t expected = 10;
   uint8_t actual = score(landing_position);
   TEST_ASSERT_EQUAL_UINT8(expected, actual);
}
...
{
   TEST_IGNORE();
   struct coordinate_t landing_position = { 0.7F, 0.7F };
   uint8_t expected = 10;
   uint8_t actual = score(landing_position);
   TEST_ASSERT_EQUAL_UINT8(expected, actual);
}
...
{
   TEST_IGNORE();
   struct coordinate_t landing_position = { 0.8F, -0.8F };
   uint8_t expected = 5;
   uint8_t actual = score(landing_position);
   TEST_ASSERT_EQUAL_UINT8(expected, actual);
}
...
{
   TEST_IGNORE();
   struct coordinate_t landing_position = { -3.5F, 3.5F };
   uint8_t expected = 5;
   uint8_t actual = score(landing_position);
   TEST_ASSERT_EQUAL_UINT8(expected, actual);
}
...
{
   TEST_IGNORE();
   struct coordinate_t landing_position = { -3.6F, -3.6F };
   uint8_t expected = 1;
   uint8_t actual = score(landing_position);
   TEST_ASSERT_EQUAL_UINT8(expected, actual);
}
...
{
   TEST_IGNORE();
   struct coordinate_t landing_position = { -7.0F, 7.0F };
   uint8_t expected = 1;
   uint8_t actual = score(landing_position);
   TEST_ASSERT_EQUAL_UINT8(expected, actual);
}
...
{
   TEST_IGNORE();
   struct coordinate_t landing_position = { 7.1F, -7.1F };
   uint8_t expected = 0;
   uint8_t actual = score(landing_position);
   TEST_ASSERT_EQUAL_UINT8(expected, actual);
}
...
{
   TEST_IGNORE();
   struct coordinate_t landing_position = { -0.5F, -4.0F };
   uint8_t expected = 5;
   uint8_t actual = score(landing_position);
   TEST_ASSERT_EQUAL_UINT8(expected, actual);
}
